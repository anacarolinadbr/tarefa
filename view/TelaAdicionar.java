...
public class TelaAdicionar extends javax.swing.JFrame {
    ...
    public TelaAdicionar(String nomeUsuario) {
    initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adicione suas tarefas!");

        campoTarefa.setBackground(new java.awt.Color(153, 153, 153));
        campoTarefa.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        campoTarefa.setForeground(new java.awt.Color(0, 0, 0));
        campoTarefa.setText("Digite sua tarefa aqui...");
        ...
        jLabel2.setText("Por favor, insira suas tarefas individualmente e clique no botão Adicionar");

        jLabel3.setFont(new java.awt.Font("Cambria", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Após a confirmação, cada tarefa será exibida automaticamente na tabela");

        jButton2.setBackground(new java.awt.Color(102, 102, 102));
        jButton2.setFont(new java.awt.Font("Cambria Math", 0, 18)); // NOI18N
        jButton2.setForeground(new java.awt.Color(0, 0, 0));
        jButton2.setText("Ir para a tabela");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(campoTarefa, javax.swing.GroupLayout.PREFERRED_SIZE, 433, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(127, 127, 127))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addGap(52, 52, 52)
                .addComponent(campoTarefa, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45)
    ...
    String sql = "INSERT INTO tarefa (tarefa, andamento) VALUES (?, ?)";

    try (Connection conn = Conexao.conectar();
         PreparedStatement stmt = conn.prepareStatement(sql)) {

        stmt.setString(1, tarefa);
        stmt.setString(2, "Pendente"); // status inicial
